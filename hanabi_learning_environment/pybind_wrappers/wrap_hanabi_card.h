...
void wrap_hanabi_card(py::module& m) {
  ...
  hanabi_card
    .def(py::init<hanabi_learning_env::HanabiCard::ColorType, hanabi_learning_env::HanabiCard::RankType>())
    .def(py::init())
  ...
  py::enum_<hanabi_learning_env::HanabiCard::ColorType> (hanabi_card, "ColorType")
    ...
    .value("kUnknownColor", hanabi_learning_env::HanabiCard::ColorType::kUnknownColor)
    .export_values();
  ...
  py::enum_<hanabi_learning_env::HanabiCard::RankType> (hanabi_card, "RankType")
    ...
    .value("kUnknownRank", hanabi_learning_env::HanabiCard::RankType::kUnknownRank)
    .export_values();
}
